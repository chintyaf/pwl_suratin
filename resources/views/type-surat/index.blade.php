...
<div class="col-12 row">
    ...
    <div class="col-8 d-flex align-items-center justify-content-end">
        <div>
            <a href="{{ route('type_surat.add') }}" class="btn btn-primary ">
        ...
        <div class="col-12 d-flex">
            <div class="card flex-fill">
                <div class="card-header">
                    ...
                    <h5 class="px-3 py-2 mb-0 card-title">Jenis Surat</h5>
                </div>
                <div class="px-4 pb-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary"
                                        ...
                                        data-url="{{ route('type_surat.edit', $data->id_type) }}"
                                        data-id="{{ $data->id_type }}"
                                        >
                                        <i class="align-middle" data-feather="edit"></i>
                                    </button>
                                    <a href="#" class="delete-button btn btn-danger"
                                        data-url="{{ route('type_surat.delete', $data->id_type) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content" id="modalContent">
                <div class="modal-header">
                    <h5 class="modal-title" id="boxTitle">Jenis Surat</h5>
