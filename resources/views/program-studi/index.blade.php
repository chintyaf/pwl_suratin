...
<div class="col-12 row">
    ...
    <div class="col-8 d-flex align-items-center justify-content-end">
        <div>
            <a href="{{ route('program_studi.add') }}" class="btn btn-primary ">
                Add Program Studi
            </a>
        </div>
    </div>
        ...
        <div class="col-12 d-flex">
            <div class="card flex-fill">
                <div class="card-header">
                    ...
                    <h5 class="px-3 py-2 mb-0 card-title">Prograam Studi</h5>
                </div>
                <div class="px-4 pb-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary"
                                        ...
                                        data-url="{{ route('program_studi.edit', $data->id_prodi) }}"
                                        data-id="{{ $data->id_prodi }}"
                                        >
                                        <i class="align-middle" data-feather="edit"></i>
                                    </button>
                                    <a href="#" class="delete-button btn btn-danger"
                                        data-url="{{ route('program_studi.delete', $data->id_prodi) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content" id="modalContent">
                <div class="modal-header">
                    <h5 class="modal-title" id="boxTitle">Program Studi</h5>
