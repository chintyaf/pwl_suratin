      ...
      <div class="me-auto pc-mob-drp">
        <ul class="list-unstyled">
          ...
          <li class="dropdown pc-h-item d-inline-flex d-md-none">
            <a class="m-0 pc-head-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
          ...
          <li class="dropdown pc-h-item">
            ...
            <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
              <div class="dropdown-header d-flex align-items-center justify-content-between">
                ...
                <a href="#!" class="bg-transparent pc-head-link"><i class="ti ti-x text-danger"></i></a>
              </div>
              <div class="dropdown-divider"></div>
              <div class="px-0 dropdown-header text-wrap header-notification-scroll position-relative"
                  ...
                  <a class="list-group-item list-group-item-action">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-1">
                        ...
                        <p class="mb-1 text-body">It's <b>Cristina danny's</b> birthday today.</p>
                  ...
                  <a class="list-group-item list-group-item-action">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-1">
                        ...
                        <p class="mb-1 text-body"><b>Aida Burg</b> commented your post.</p>
                  ...
                  <a class="list-group-item list-group-item-action">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-1">
                        ...
                        <p class="mb-1 text-body"><b>There was a failure to your setup.</b></p>
                  ...
                  <a class="list-group-item list-group-item-action">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-1">
                        ...
                        <p class="mb-1 text-body"><b>Cristina Danny </b> invited to join <b> Meeting.</b></p>
            ...
            <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
              <div class="dropdown-header">
                <div class="mb-1 d-flex">
                  ...
                  <a href="#!" class="bg-transparent pc-head-link"><i class="ti ti-power text-danger"></i></a>
                </div>
              </div>
