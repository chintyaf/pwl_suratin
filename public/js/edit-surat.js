document.addEventListener("DOMContentLoaded", () => {
    document.querySelector("tbody").addEventListener("click", async (event) => {
        ...
        try {
            ...
            //
            //     if (titleEl && bodyEl) {
            //         titleEl.innerText = surat_name;
            //         bodyEl.innerHTML = bodyRes;
            //
            //         let modal = new bootstrap.Modal(document.getElementById('myModal'));
            //         modal.show();
            //     } else {
            //         console.warn("Modal structure missing #suratDetailTitle or #suratDetailBody");
            //     }
            // }, 50); // Delay kecil untuk pastikan DOM siap
